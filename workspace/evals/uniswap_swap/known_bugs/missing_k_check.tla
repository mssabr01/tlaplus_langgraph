--------------------------- MODULE missing_k_check ---------------------------
(* MUTANT: Swap does NOT enforce the constant product invariant.
   TLC should find a violation of ConstantProductInvariant. *)
...
(* BUG: No constant product check — user can swap arbitrary amounts *)
Swap0For1 ==
    /\ userBalance0 > 0
...
(* This SHOULD be violated because swaps don't enforce k *)
ConstantProductInvariant ==
    reserve0 * reserve1 >= MaxBalance * MaxBalance
